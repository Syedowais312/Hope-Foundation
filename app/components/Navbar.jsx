    ...
    <nav className="fixed w-full top-0 z-50 bg-white/10 backdrop-blur-md border-b border-white/20 shadow-sm">
      <div className="max-w-7xl mx-auto flex items-center justify-between p-4 px-6 md:px-10">
        ...
        <div className="hidden md:flex space-x-8 text-gray-200 font-medium">
          <a href="#home" onClick={handleLinkClick} className="hover:text-purple-400 transition duration-300">
            Home
          </a>
          <a href="#about" onClick={handleLinkClick} className="hover:text-purple-400 transition duration-300">
            About
          </a>
          <a href="#contact" onClick={handleLinkClick} className="hover:text-purple-400 transition duration-300">
            Contact
          </a>
        </div>
          ...
          {isLoggedIn ? (
            <>
              <Link href="/my-contribution">
                <button
                  onClick={handleLinkClick}
                  className="px-4 py-2 bg-purple-700 rounded-lg text-white hover:bg-purple-800 transition"
                >
                  My Contribution
                </button>
              </Link>
        ...
        <button
          ...
          className="md:hidden inline-flex items-center justify-center p-2 rounded-md text-gray-200 hover:text-white hover:bg-gray-700 focus:outline-none"
          ...
          <div className="border-t border-white/20 mt-2 pt-2 px-4">
            {isLoggedIn ? (
              <>
                <Link href="/my-contribution">
                  <button
                    ...
                    className="w-full mb-2 px-4 py-2 bg-purple-700 rounded-lg text-white hover:bg-purple-800 transition"
                  >
                    My Contribution
                  </button>
                </Link>
                <button
                  ...
                  className="w-full px-4 py-2 bg-red-600 rounded-lg text-white hover:bg-red-700 transition"
                >
                  Logout
                </button>
              </>
              ...
              <button
                ...
                className="w-full px-4 py-2 bg-green-600 rounded-lg text-white hover:bg-green-700 transition"
              >
                Login
              </button>
            )}
